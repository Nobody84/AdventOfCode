...
using AOC2024.Puzzels;

//var day1 = new Day1_HistorianHysteria();
//Console.WriteLine($"Day1 - Part1: {day1.Part1()}");
//Console.WriteLine($"Day1 - Part2: {day1.Part2()}");

//var day2 = new Day2_RedNosedReports();
//Console.WriteLine($"Day2 - Part1: {day2.Part1()}");
//Console.WriteLine($"Day2 - Part2: {day2.Part2()}");

//var day3 = new Day3_MullItOver();
//Console.WriteLine($"Day3 - Part1: {day3.Part1()}");
//Console.WriteLine($"Day3 - Part2: {day3.Part2()}");

//var day4 = new Day4_CeresSearch();
//Console.WriteLine($"Day4 - Part1: {day4.Part1()}");
//Console.WriteLine($"Day4 - Part2: {day4.Part2()}");

//var day5 = new Day5_PrintQueue();
...
var day8 = new Day8_ResonantCollinearity();
day8.Run();
